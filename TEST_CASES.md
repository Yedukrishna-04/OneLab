...
- [test_detectors.py](D:/OneLab/reconciler/tests/test_detectors.py)
...
- [transactions.csv](D:/OneLab/reconciler/data/transactions.csv)
- [settlements.csv](D:/OneLab/reconciler/data/settlements.csv)
...
- [detectors.py](D:/OneLab/reconciler/engine/detectors.py)
- [matcher.py](D:/OneLab/reconciler/engine/matcher.py)
